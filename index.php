...
<section class="my-5" id="contact">
  ...
  <div>
  <p class="text-center bg-dark text-white">Hrisikesh Pal : +91 9563804606 <br> Mail : <a style="text-decoration:none;color:white;" href="mailto:mailtoviruszzwarning@gmail.com" >mailtoviruszzwarning@gmail.com</a><br> GitHub : <a style="text-decoration:none;color:white;" href="https://www.github.com/VirusZzHkP">VirusZzHkP</a></p>
